...
export function generateMetadata(): Metadata {
    return getPageMetadata("/blz/term-and-condition");
}
...
export default function TermConditon() {
    return (
        <>
            <BreadCrumb title='Term and Conditon' />
            <div className="gps footer min-h-screen  flex justify-center">
                <div className="bg-white rounded-lg md:p-8 w-full max-w-6xl">
                    <section>
                        <div className='elementor-widget-container text-justify'>
                            <p className='mb-5'>Last updated on Jan 16 2024</p>
                            <p className='mb-5 '>For the purpose of these Terms and Conditions, The term “we”, “us”, “our” used anywhere on this page shall mean BLAZONLABS ITECH PRIVATE LIMITED, whose registered/operational office is e6/263, chitrakoot scheme, ajmer road Jaipur RAJASTHAN 302021 . “you”, “your”, “user”, “visitor” shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.</p>
                            <p className='mb-5'><strong>Your use of the website and/or purchase from us are governed by following Terms and Conditions:</strong></p>
                            <ul>
                                ...
                                <li>You may not create a link to our website from another website or document without BLAZONLABS ITECH PRIVATE LIMITED’s prior written consent.</li>
